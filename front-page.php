        ...
        <div id="primary" class="content-area">
            <main id="main" class="site-main" role="main" tabindex="-1">
            	...
            	<div class="content-tile">
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/images/mh.png" id="front-page-image" alt="Millican Hall at UCF"/>
                    <p>
                ...
                <div style="clear:both;"></div>
              	<div class="content-tile">
                    <div style="float: right;">
                        <label for="committee-select">Filter members by committee:</label>
